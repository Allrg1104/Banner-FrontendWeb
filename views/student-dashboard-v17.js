/**
 * Student Dashboard View - Analytical Intelligence (v17)
 * Renamed to bypass Nginx cache
 */
        ...
        return `
            <div class="space-y-8 animate-fade-in">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <h2 class="text-3xl font-black text-slate-900 tracking-tight">Dashboard Dinámico (v17)</h2>
